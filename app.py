...
def get_summary(page_content):
    summary = model.generate_content(f'summarize the travel blog content and try to give the budget for the destination as discussed in travel blog and also summarize the travel iternary plan : {page_content}').text
